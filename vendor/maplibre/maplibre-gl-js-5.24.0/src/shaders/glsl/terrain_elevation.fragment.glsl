...
void main() {
    // Map absolute meters to 0..1 range
    // -10000m to +10000m covers all earth terrain
    float normalizedElev = (v_elevation + 10000.0) / 20000.0;
    fragColor = pack(clamp(normalizedElev, 0.0, 1.0));
}
