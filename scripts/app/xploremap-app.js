    ...
    const BASEMAP_OPTIONS = [
      {
        ...
        label: 'Outdoor',
        isStyleSwap: true,
        styleUrl: './styles/map-styles/xplore_outdoor_hybrid-2.json?v=20260525-relief-wip',
      ...
      },
      {
        ...
        label: 'Xplore',
        isStyleSwap: true,
        styleUrl: './styles/map-styles/xplore_outdoor_hybrid.json?v=20260523-color-relief-strong',
