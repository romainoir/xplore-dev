...
const stylePath = path.resolve('styles/map-styles/osm_liberty.json');
...
const intro = [
  ...
  '',
  'Generated by `scripts/generate-openfreemap-icon-table.mjs`. When the remote sprite metadata is unavailable, the script infers icons from the local `styles/map-styles/osm_liberty.json` filters, so the list may be limited.',
  ''
];
