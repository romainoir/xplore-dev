...
void main() {
    ...
    float diskRadius = 0.0087; // 0.5 degrees, close to the apparent solar diameter.
    float glowRadius = 0.060;
    ...
    skyColor.rgb = mix(skyColor.rgb, glowColor, clamp(glow * sunAmount * 0.42, 0.0, 0.55));
