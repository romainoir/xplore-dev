...
export {drawSymbols, drawCircles, drawHeatmap, drawLine, drawFill, drawFillExtrusion,
    drawHillshade, drawColorRelief, drawShadow, drawDaylight, drawRaster, drawBackground,
...
export type DrawFunctions = {
    ...
    shadow: typeof drawShadow;
    daylight: typeof drawDaylight;
